...
GLuint vbo_geometry3;// VBO handle for our geometry
GLuint vbo_geometryStart;// VBO handle for our geometry
GLuint vbo_geometryFinish;// VBO handle for our geometry
GLuint vbo_geometryDragon;// VBO handle for our geometry (Dragon)
...
glm::mat4 mvp;//premultiplied boardviewprojection
glm::mat4 mvp2;//premultiplied ballviewprojection
glm::mat4 mvp3;//premultiplied floorviewprojection
...
void render()
{
    ...
    mvp = projection * view * board;
    mvp2 = projection * view * ball;
    mvp3 = projection * view * floorMat;
...
// do the same for the floor
    ...
    glEnableVertexAttribArray(loc_position);
    glEnableVertexAttribArray(loc_color);
    glBindBuffer(GL_ARRAY_BUFFER, vbo_geometry3);
    //set pointers into the vbo for each of the attributes(position and color)
    glVertexAttribPointer( loc_position,//location of attribute
                           3,//number of elements
                           GL_FLOAT,//type
...
// do the same for the Start
    ...
    glEnableVertexAttribArray(loc_position);
    glEnableVertexAttribArray(loc_color);
    glBindBuffer(GL_ARRAY_BUFFER, vbo_geometryStart);
    //set pointers into the vbo for each of the attributes(position and color)
    glVertexAttribPointer( loc_position,//location of attribute
                           3,//number of elements
                           GL_FLOAT,//type
...
// do the same for the Finish
    ...
    glEnableVertexAttribArray(loc_position);
    glEnableVertexAttribArray(loc_color);
    glBindBuffer(GL_ARRAY_BUFFER, vbo_geometryFinish);
    //set pointers into the vbo for each of the attributes(position and color)
    glVertexAttribPointer( loc_position,//location of attribute
                           3,//number of elements
                           GL_FLOAT,//type
...
// do the same for the Dragon
    ...
    glEnableVertexAttribArray(loc_position);
    glEnableVertexAttribArray(loc_color);
    glBindBuffer(GL_ARRAY_BUFFER, vbo_geometryDragon);
    //set pointers into the vbo for each of the attributes(position and color)
    glVertexAttribPointer( loc_position,//location of attribute
                           3,//number of elements
                           GL_FLOAT,//type
...
void cleanUp()
{
    ...
    glDeleteBuffers(1, &vbo_geometry3);
}
