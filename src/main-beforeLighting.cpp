...
/*
    char *fileVS, *fileFS;
    const char* vsName = "vShader.txt";
    const char* fsName = "fShader.txt";
...
*/
    ...
    int InfoLogLength;
        ...
        std::ifstream VertexShaderStream("vertexShader.txt", std::ios::in);
        ...
        std::ifstream FragmentShaderStream("fragmentShader.txt", std::ios::in);
...
*/
    ...
    View_ID = glGetUniformLocation(program, "V");
    Model_ID = glGetUniformLocation(program, "M");

    loc_position = glGetAttribLocation(program, "v_position" );
    //loc_position = glGetAttribLocation(program, "vertexPosition_modelspace" );
    //loc_normal = glGetAttribLocation(program, "vertexNormal_modelspace" );
