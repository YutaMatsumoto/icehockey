...
//    objs.push_back( dragon );
    ...
    loc_Shineness       = glGetUniformLocation( program2, "Shininess");
    loc_Sampler         = glGetUniformLocation( program2, "Sampler");      
    loc_SpotDirection   = glGetUniformLocation( program2, "SpotDirection");      
    loc_LightCutOff     = glGetUniformLocation( program2, "LightCutOff");       
