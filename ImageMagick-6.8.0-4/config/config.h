...
#define CODER_PATH "/usr/local/lib/ImageMagick-6.8.0/modules-Q16/coders/"

/* Subdirectory of lib where coder modules are installed */
#define CODER_RELATIVE_PATH "ImageMagick-6.8.0/modules-Q16/coders"
...
#define PACKAGE_STRING "ImageMagick 6.8.0-4"
...
#define SHAREARCH_PATH "/usr/local/lib/ImageMagick-6.8.0/config/"

/* Subdirectory of lib where architecture-independent configuration files
   live. */
#define SHAREARCH_RELATIVE_PATH "ImageMagick-6.8.0/config"
